            ...
            <div className="body-resep ">
                ...
                <div className="flex items-center justify-center">
                    <div className="detail4 ">
                        ...
                        <div className="button-rating flex items-center justify-center">
                            <button type="submit" onClick={this.toggleModal} >Beri Rating</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="detail5 flex items-center justify-center">
                    ...
                    <div className="detail-recook">
                        ...
                        <div className="button-recook flex items-center justify-center">
                            <button type="submit" onClick={this.toggleModal} >Bagikan Hasil recook</button>
                        </div>
                    </div>
                </div>
                <br /><br />
                ...
                <div className="detail5 flex items-center justify-center">
                    ...
                    <div className="detail-recook">
                        ...
                        <br />
                        <div className="button-recook flex items-center justify-center">
                            <button type="submit" onClick={this.toggleModal} >Mulai Berdiskusi</button>
                        </div>
                    </div>
                </div>
